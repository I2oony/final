...
router.post(
    ...
    async (req, res) => {
        try{
            ...
            //
            //
            // console.log('Ищется юзер с таким же именем');
            // if(candidate){
            //     return res.status(400).json({message: "This user already exists."});
            // }
            // console.log('Не найден');
            // const hashedPassword = await bcript.hash(userpass, 12);
            // console.log('Хеширование пароля завершено');
            // const user = new User({username: username, userpass: hashedPassword});
            // await user.save();
